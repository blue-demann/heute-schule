...
1. **🟡 Juristische Prüfung vor weiterer Ausweitung.** Haushaltsausnahme
   ...
   Art. 30), TOM-Abschnitt in der Datenschutzerklärung. Noch zu tun:
   - AVV-Behauptung gegenüber Cloudflare tatsächlich im Konto verifizieren
   - Einschätzung durch jemanden mit juristischem Hintergrund einholen
   - Speicherdauer der Cloudflare-Server-Logs klären
2. **Kosmetisch, keine Eile:** Die WCAG-Versionsangaben in den beiden
