...
export default [
  ...
  // proxy/* und web/sw.js: laufen als Service Worker bzw. in der
  // Cloudflare-Workers-Runtime, nicht in Node — andere Globals (fetch,
  // caches, crypto u. a. wie im Service-Worker-Standard).
  {
